...
describe('Employee', () => {
    ...
    describe('Reading data', () => {
        ...
        before(async () => {
            const testEmpOne = new Employee({_id: '5d9f1140f10a81216cfd4408', firstName: 'John', lastName: 'Doe', department: 'It', salary: 2137 });
            await testEmpOne.save();

            const testEmpTwo = new Employee({_id: '6d9f1140f10a81216cfd4408', firstName: 'Robert', lastName: 'Lewandowski', department: 'Geodezja', salary: 100 });
    ...
    describe('Updating data', () => {
        ...
        it('should properly update one document with "save" method', async () => {
            ...
            const updatedEmployee = await Employee.findOne({ firstName: '=Department #1=' });
            expect(updatedEmployee).to.not.be.null;
        });
